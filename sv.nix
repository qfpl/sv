...
, charset, containers, hedgehog, lens, mtl, parsers, profunctors
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ansi-wl-pprint base bifunctors bytestring charset containers lens
    mtl parsers profunctors readable semigroupoids semigroups separated
    text transformers trifecta validation
  ];
  testHaskellDepends = [
